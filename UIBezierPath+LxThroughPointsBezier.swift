...
func ObliqueAngleOfStraightThrough(_ point1: CGPoint, point2: CGPoint) -> CGFloat {    //  [-π/2, 3π/2)
...
func ControlPointForTheBezierCanThrough(_ point1: CGPoint, point2: CGPoint, point3: CGPoint) -> CGPoint {
